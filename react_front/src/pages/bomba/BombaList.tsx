                            ...
                            <tbody>
                                {rifasList.map((bomba: Bomba) =>
                                    <tr className="even:bg-blue-gray-50/50" key={"bomba" + bomba.id}>
                                        ...
                                        <td>
                                            <TailwindLink text="realizar accion" to={Routes.SURTIDOR.EDIT_PARAM(bomba.id)} />
                                        </td>
                                        <td>
                                            <TailwindLink text="Editar" to={Routes.SURTIDOR.EDIT_PARAM(bomba.id)} />
                                        </td>
                                        <td>
